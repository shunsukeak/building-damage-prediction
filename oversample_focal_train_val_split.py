...
# === パラメータ設定 ===
crop_metadata_csv = "./cropped_building_metadata_with_shapes.csv"
output_dir = "./type_train_val_split_with_shape_oversampled"
train_ratio = 0.8
random_seed = 42

# === 災害タイプごとのoversampling倍率 ===
oversample_factors = {
