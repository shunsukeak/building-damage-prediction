# 2step_gat_damage_focal_test2.py
import os
import torch
...
def evaluate():
    ...
    for fname in os.listdir(graph_dir):
        if not fname.endswith("_step2.pt"):
            continue
        dtype = fname.replace("graph_", "").replace("_step2.pt", "")
        print(f"\n🧪 Evaluating step2 graph for disaster type: {dtype}")
    ...
    print("\n📊 Overall GAT Test Evaluation (step2 graphs):")
